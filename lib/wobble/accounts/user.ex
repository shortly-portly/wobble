defmodule Wobble.Accounts.User do
  use Ecto.Schema
  ...
  def organisation_registration_changeset(user, attrs, opts \\ []) do
    ...
    |> cast_assoc(:organisation,
      with: &Wobble.Organisations.Organisation.changeset/2,
      required: true
    )
  end
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, Wobble.Repo)
  ...
  """
  def valid_password?(%Wobble.Accounts.User{hashed_password: hashed_password}, password)
