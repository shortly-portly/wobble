defmodule WobbleWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(WobbleWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(WobbleWeb.Gettext, "errors", msg, opts)
    end
  end
  ...
  def menu_group(assigns) do
    ...
    <div class="pt-2">
      ...
      <div id={"#{@id}-items"} class="py-2 hidden">
        <%= render_slot(@inner_block) %>
      </div>
    </div>
    """
