defmodule WobbleWeb.UserAuthTest do
  use WobbleWeb.ConnCase, async: true

  alias Phoenix.LiveView
  alias Wobble.Accounts
  alias WobbleWeb.UserAuth
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, WobbleWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      WobbleWeb.Endpoint.subscribe(live_socket_id)
